...
_G.packer_plugins = {
  ["base16-vim"] = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/base16-vim"
  },
  ["gruvbox.nvim"] = {
    loaded = true,
  ...
  vim = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/vim"
  },
  ["vim-sensible"] = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/vim-sensible"
  }
}
